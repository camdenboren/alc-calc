...
You can generate these bundles manually by cloning, installing rustc + cargo (v1.97.1 msvc w/ W11 SDK) and boxes (v2.3.1), then installing cargo-packager and executing the Windows script
...
> [!NOTE]
> You'll need to install `cargo-edit` (v0.13.13) first if you're not using Nix
